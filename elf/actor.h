...
void elfDrawActorDebug(elfActor* actor, gfxShaderParams* shaderParams)
{
	...
	else if(actor->shape == ELF_CONE_X)
	{
		...
		vertexBuffer[0] = halfLength+actor->pbbOffset.x;
		vertexBuffer[1] = 0.0f+actor->pbbOffset.y;
		vertexBuffer[2] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[3] = -halfLength+actor->pbbOffset.x;
		vertexBuffer[4] = size+actor->pbbOffset.y;
		vertexBuffer[5] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[6] = halfLength+actor->pbbOffset.x;
		vertexBuffer[7] = 0.0f+actor->pbbOffset.y;
		vertexBuffer[8] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[9] = -halfLength+actor->pbbOffset.x;
		vertexBuffer[10] = -size+actor->pbbOffset.y;
		vertexBuffer[11] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[12] = halfLength+actor->pbbOffset.x;
		vertexBuffer[13] = 0.0f+actor->pbbOffset.y;
		vertexBuffer[14] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[15] = -halfLength+actor->pbbOffset.x;
		vertexBuffer[16] = 0.0f+actor->pbbOffset.y;
		vertexBuffer[17] = size+actor->pbbOffset.z;
		vertexBuffer[18] = halfLength+actor->pbbOffset.x;
		vertexBuffer[19] = 0.0f+actor->pbbOffset.y;
		vertexBuffer[20] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[21] = -halfLength+actor->pbbOffset.x;
		vertexBuffer[22] = 0.0f+actor->pbbOffset.y;
		vertexBuffer[23] = -size+actor->pbbOffset.z;
	...
	else if(actor->shape == ELF_CONE_Y)
	{
		...
		vertexBuffer[1] = halfLength+actor->pbbOffset.y;
		vertexBuffer[2] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[3] = size+actor->pbbOffset.x;
		vertexBuffer[4] = -halfLength+actor->pbbOffset.y;
		vertexBuffer[5] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[6] = 0.0f+actor->pbbOffset.x;
		vertexBuffer[7] = halfLength+actor->pbbOffset.y;
		vertexBuffer[8] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[9] = -size+actor->pbbOffset.x;
		vertexBuffer[10] = -halfLength+actor->pbbOffset.y;
		vertexBuffer[11] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[12] = 0.0f+actor->pbbOffset.x;
		vertexBuffer[13] = halfLength+actor->pbbOffset.y;
		vertexBuffer[14] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[15] = 0.0f+actor->pbbOffset.x;
		vertexBuffer[16] = -halfLength+actor->pbbOffset.y;
		vertexBuffer[17] = size+actor->pbbOffset.z;
		vertexBuffer[18] = 0.0f+actor->pbbOffset.x;
		vertexBuffer[19] = halfLength+actor->pbbOffset.y;
		vertexBuffer[20] = 0.0f+actor->pbbOffset.z;
		vertexBuffer[21] = 0.0f+actor->pbbOffset.x;
		vertexBuffer[22] = -halfLength+actor->pbbOffset.y;
		vertexBuffer[23] = -size+actor->pbbOffset.z;
